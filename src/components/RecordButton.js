...
export default function RecordButton() {
  return (
    <div class="flex justify-center items-center absolute right-20">   
        <button class="w-16 h-16 rounded-full bg-lime-700 focus:outline-none flex justify-center items-center">
